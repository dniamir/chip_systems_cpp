...
class BME680 : public Chip {
  ...
  std::map<String, Field> field_map {
    ...
    {"par_t1",  Field{0xe9, 0, 16, false}},
    {"par_t2", Field{0x8a, 0, 16, false}},
    {"par_t3", Field{0x8c, 0, 8, false}},
    {"par_p1", Field{0x8e, 0, 16, false}},
    {"par_p2", Field{0x90, 0, 16, false}},
    {"par_p3", Field{0x92, 0, 8, false}},
    {"par_p4", Field{0x94, 0, 16, false}},
    {"par_p5", Field{0x96, 0, 16, false}},
    {"par_p6", Field{0x99, 0, 8, false}},
    {"par_p7", Field{0x98, 0, 8, false}},
    {"par_p8", Field{0x9c, 0, 16, false}},
